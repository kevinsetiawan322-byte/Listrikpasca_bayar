<?php  
	...
	//Untuk menghindari error gunakan isset
	$id_petugas_sebelumnya = isset($petugas['id_petugas']) ? $petugas['id_petugas'] : 'P'.$today.'000';
	$kode = substr($id_petugas_sebelumnya, 9,3) + 1;
								...
								<form method="post">
									...
									<div class="form-group">
										...
										if (@$_GET['id']=="") {?>
										 ...
										 <?php }else{?>
											<input type="submit" name="ubah" class="btn btn-danger btn-block btn-lg" value="UBAH">
										 <?php } ?>
