<?php  
	// Jika tidak ada parameter 'menu' dalam URL, maka redirect ke halaman utama
	if (!isset($_GET['menu'])) {
	...
	// Jika ID Pelanggan dikirim melalui POST
	...
	// Jika terdapat parameter 'hapus' atau 'edit' dalam URL
		...
		// Mengambil data pelanggan dan tarif berdasarkan ID Pelanggan
		...
		// Menentukan bulan dan tahun berikutnya
		if ($bulan==12) {
			if($bulan<10){
				$bln = ($bulan+1);
				$next_bulan = "0".$bln;
	...
	// Menghitung jumlah pemakaian dan tagihan
	...
	// echo $id_penggunaan_next."-".$tahun."-".$bulan; Data yang akan disimpan untuk penggunaan selanjutnya
	@$field_next = array(
