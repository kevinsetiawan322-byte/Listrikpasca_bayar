<!-- INI LAPORAN TAGIHAN PERIODE-->
					<?php }elseif(isset($_GET['tagihan_periode'])){ 
						...
						// Inisialisasi tabel dan mengambil data berdasarkan status dan periode waktu yang dipilih
							$table = "qw_tagihan";
                            $status = $_POST['status'];
							// Menentukan rentang bulan dan tahun
							...
							// Menyiapkan link untuk cetak dan export data
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div class="pull-right">
								<!-- Tombol untuk mencetak dan mengekspor laporan -->
						...
						<div class="panel-body">
							<div class="col-md-12">
								<!-- Form untuk memilih status dan rentang waktu laporan -->
								<form method="post">
