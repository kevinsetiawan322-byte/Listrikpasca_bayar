...
<!-- INI LAPORAN RIWAYAT PENGGUNAAN -->
					<?php }elseif(isset($_GET['riwayat_penggunaan'])){ 
							if (isset($_POST['bcari'])) {
								...
								$nama_pelanggan = isset($pelanggan['nama']) ? strtoupper($pelanggan['nama']) : 'TIDAK DIKETAHUI';
								$judul = "LAPORAN RIWAYAT PENGGUNAAN $id_pelanggan - $nama_pelanggan PADA TAHUN $tahun";
