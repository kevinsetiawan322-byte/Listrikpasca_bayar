			...
			<?php if(isset($_GET['excel'])){ ?>
				...
				<?php }else{ ?>
					<td style="margin-top: -20px;" width="15%" valign="top">
						<img src="../images/logo_11.png" width="90px" height="90px">
					</td>
				<?php } ?>
			<td colspan="10" align="left">
				<h4 style="margin-top: 10px;margin-left: -70px;">PERUSAHAAN PEMBAYARAN LISTRIK</h4>
				<h1 style="margin-top: -20px;margin-left: -70px;" >ELECTROPAY</h1>
				<h5 style="margin-top: -20px;margin-left: -70px;">Jl. Jengki. Cipinang Asem kav , RT.13/RW.4, Kebon pala, Makasar, Jakarta Timur, Jakarta 13650</h5>
			</td>
		</tr>
...
<!-- INI FOOTER LAPORAN -->
	<div id="footer">
		<table align="right" style="margin-right: 100px;">
			...
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td align="center"><?php echo $_SESSION['nama_agen']; ?></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
		</table>
	</div>
