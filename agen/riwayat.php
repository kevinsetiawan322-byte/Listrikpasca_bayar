<?php
	// Jika parameter 'menu' tidak ada di URL, redirect ke halaman utama dengan menu riwayat
	if (!isset($_GET['menu'])) {
	...
	if (isset($_POST['bcari'])) {
		$text = $_POST['tcari'];
		// Query pencarian berdasarkan berbagai parameter dalam database
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<!-- Tabel untuk menampilkan daftar riwayat pembayaran -->
