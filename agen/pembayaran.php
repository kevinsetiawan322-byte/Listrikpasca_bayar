<?php  
	// Jika parameter 'menu' tidak ada dalam URL, arahkan ke halaman pembayaran
	if (!isset($_GET['menu'])) {
	...
	// Membuat ID pembayaran otomatis berdasarkan tanggal hari ini
	$hari_ini = date("Ymd");
		...
		<div class="row">
			...
			<?php  
				if (isset($_POST['bcari_id'])) {
					...
					//gunakan isset untuk menghindari error
					$id_tarif = isset($pelanggan['id_tarif']) ? $pelanggan['id_tarif'] : 0;
					$tarif = $aksi->caridata("tarif WHERE id_tarif = '$id_tarif'");
